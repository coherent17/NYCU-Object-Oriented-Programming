...
bool song_cmp(const Song *s1, const Song *s2){
    int min1 = stoi(s1->get_song_len().substr(0, s1->get_song_len().find(":")));
    int sec1 = stoi(s1->get_song_len().substr(s1->get_song_len().find(":") + 1));
    int min2 = stoi(s2->get_song_len().substr(0, s2->get_song_len().find(":")));
    int sec2 = stoi(s2->get_song_len().substr(s2->get_song_len().find(":") + 1));
